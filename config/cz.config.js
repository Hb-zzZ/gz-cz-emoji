...
module.exports = {
  ...
  messages: {
    ...
    generatedSelectByAI: "通过人工智能生成选择合适的主题 :",
  },
  types: [
    {
      value: "feat",
    ...
    {
      value: "ui",
      name: "ui:       💄  修改样式 | Add or update the UI and style files",
      emoji: "💄",
    },
    {
      value: "style",
    ...
    {
      value: "init",
      name: "init:     🎉  初始项目 | Begin a project",
      emoji: "🎉",
    },
  ],
  useEmoji: true,
